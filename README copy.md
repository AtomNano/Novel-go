...
### Setup dengan 2 Device (Recommended untuk Team Setup)

Untuk setup dengan 2 laptop:

1. **Device A** (Service Backend):
   - Read: [SETUP_DEVICE_A.md](SETUP_DEVICE_A.md)
   - Jalankan: Auth Service (3001), Laravel Content (8080), Collection Service (3002)

2. **Device B** (Interaction Service + Flutter):
   - Read: [SETUP_DEVICE_B.md](SETUP_DEVICE_B.md)
   - Jalankan: Python Social Service (5003), Flutter App

3. **Quick Reference**: [QUICK_START.md](QUICK_START.md)

---

### Setup Lokal dengan Docker (Single Device)
